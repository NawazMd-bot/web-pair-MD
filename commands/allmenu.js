...
async function allMenu(sock, from, msg, session, commands) {
    ...
    const categories = {
        ...
        '✏️ TEXT MAKER': ['nawaz', 'cup', 'coffee', 'cloud', 'smoke', 'flower', 'leaf', 'wood', 'stone', 'blood', 'horror', 'scary', 'spooky', 'christmas', 'birthday', 'love', 'heart']
    };
    ...
    // ===== FOOTER =====
    allMenuText += `☠️  *POWERED BY : NAWAZ MD*  ☠️`;
